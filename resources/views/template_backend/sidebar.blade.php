...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ url('/') }}" class="brand-link">
        <img src="{{ asset('img/logo-sis.jpg') }}" alt="Logo Sekolah" class="brand-image img-circle elevation-3" style="opacity: .9; height: 33px;">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @elseif (Auth::user()->role == 'Guru' && Auth::user()->guru(Auth::user()->id_card))
                    ...
                    <li class="nav-item">
                        <a href="{{ route('guru.riwayat.absensiswa') }}" class="nav-link" id="RiwayatAbsenSiswa">
                            <i class="fas fa-calendar-check nav-icon"></i>
                            <p>Absen Siswa</p>
                        </a>
                    </li>
