    ...
    public function dashboard()
{
    ...
    public function riwayatAbsenSiswa(Request $request)
{
    $guru = Guru::where('id_card', Auth::user()->id_card)->first();
    $mapelGuru = $guru->mapel->nama_mapel ?? null;
    ...
    $dataAbsensi = $query->orderBy('created_at', 'desc')->get();

    return view('guru.absensiswa', compact('dataAbsensi'));
}
