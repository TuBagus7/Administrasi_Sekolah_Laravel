    ...
    public function index()
{
    ...
    // Ambil satu ID kelas pertama
    $firstKelasId = $jadwal->first()->kelas_id ?? null;

    if ($firstKelasId) {
        return redirect()->route('ulangan.show', Crypt::encrypt($firstKelasId));
    } else {
        return redirect()->back()->with('error', 'Guru ini belum memiliki jadwal mengajar.');
    }
}
